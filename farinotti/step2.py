...
src_files = glob.glob('/media/storage/glacier_dash_data/farinotti/step1/*.tif')
print(src_files)

base_dir = '/media/storage/glacier_dash_data/index_tiles/'
dst_files = [base_dir + '{}.tif'.format(i) for i in range(24)]
out_names = ['/media/storage/glacier_dash_data/farinotti/step2/H_{}.tif'.format(i) for i in range(24)]
